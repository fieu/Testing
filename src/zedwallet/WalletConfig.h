...
namespace WalletConfig
{
    ...
    const std::string addressPrefix = "iooo";

    /* Your coins 'Ticker', e.g. Monero = XMR, Bitcoin = BTC */
    const std::string ticker = "MLC";
    ...
    const std::string daemonName = "Millecoind";
    ...
    const std::string contactLink = "http://chat.millecoin.cx";
